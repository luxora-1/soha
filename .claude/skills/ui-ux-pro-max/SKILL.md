...
This skill is installed at the project level (`.claude/skills/ui-ux-pro-max/`, see `.claude/skills/README.md`). Run the search script from the project root; the path below is relative to it:
