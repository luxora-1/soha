...
export function Supports() {
  ...
  return (
    <section id="supports" aria-labelledby="supports-heading" className="relative isolate -mt-8 overflow-hidden rounded-t-[2.5rem] bg-ink text-on-ink md:rounded-t-[3.5rem]">
      ...
      <Container className="py-section lg:py-section-lg">
        <div className="grid items-center gap-10 lg:grid-cols-12 lg:gap-16">
          <div data-reveal="" className="lg:col-span-5">
            <ImageSlot {...slot(supports.slot)} sizes="(min-width: 1024px) 40vw, 100vw" className="rounded-[2rem] shadow-lift" />
          </div>
          <div data-reveal="" className="lg:col-span-6 lg:col-start-7">
            <h2 id="supports-heading" className="text-on-ink">
              {supports.headline.lead} {supports.headline.accent}
            </h2>
